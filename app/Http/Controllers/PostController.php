...
class PostController extends Controller
{
    ...
    {
        return view('posts.posts')->withPosts($this->masterController->index());
    }
    ...
    {
        return view('posts.posts')->withPosts($this->masterController->user_posts());
    }
    ...
    {
        return view('posts.post')->withPost($this->masterController->show($post));
    }
