...
class CommentController extends Controller
{
    ...
    {
        return view('comments.comments')->withComments($this->masterController->index($post));
    }
    ...
    {
        return view('comments.comment')->withComment($this->masterController->show($post,$comment));
    }
    ...
    public function edit( $comment)
    {
        ...
        return view('comments.edit_comment')->withComment($comment);
    }
