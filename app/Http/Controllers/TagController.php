...
class TagController extends Controller
{
    ...
    {
        return view('tags.tags')->withTags($this->masterController->index());
    }
    ...
    {
        return view('tags.tag')->withTag($this->masterController->show($tag));
    }
    ...
    public function edit($tag)
    {
        ...
        return view('tags.edit_tag')->withTag($tag);
    }
