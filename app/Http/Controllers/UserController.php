...
class UserController extends Controller
{
    ...
    {
        return view('users.users')->withUsers($this->masterController->index());
    }
    ...
    {
        return view('users.profile')->withUser($this->masterController->show($user));
    }
    ...
    {
        return view('posts.posts')->withPosts($this->masterController->posts($user));
    }
    ...
    public function edit($user)
    {
        ...
        return view('users.edit_user')->withUser($user);
    }
